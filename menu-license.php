	...
	class AcrossWP_Main_Menu_Licenses {
		...
		function license_menu() {
			...
			if ( class_exists( 'AcrossWP_Main_Menu' ) && ! empty( $this->get_packages() ) ) {
				add_submenu_page(
					ACROSSWP_MAIN_MENU,
					__( 'AcrossWP License Keys', 'acrosswp' ),
					__( 'License Keys', 'acrosswp' ),
					'manage_options',
			...
			<div class="wrap acrosswp-updater-wrap">
				...
				<div class="acrosswp-updater-block-container">
					<div class="acrosswp-updater-block">
						<div class="inside">
							<h2><?php _e( 'Benefits of a License', 'acrosswp' ); ?></h2>
							<ul>
								<li>
									<strong><?php _e( 'Stay Up to Date', 'acrosswp' ); ?></strong><br/>
									<?php _e( 'Get the latest features right away', 'acrosswp' ); ?>
								</li>
								<li>
									<strong><?php _e( 'Admin Notifications', 'acrosswp' ); ?></strong><br/>
									<?php _e( 'Get updates in WordPress', 'acrosswp' ); ?>
								</li>
								<li>
									<strong><?php _e( 'Professional Support', 'acrosswp' ); ?></strong><br/>
									<?php _e( 'Get help with any questions', 'acrosswp' ); ?>
								</li>
							</ul>
						</div>
					</div>
					...
					switch ( $license_data->error ) {
						case 'expired':
							$message = sprintf(
								...
								__( 'Your license key expired on %s.', 'acrosswp' ),
						...
						case 'disabled':
						case 'revoked':
							$message = __( 'Your license key has been disabled.', 'acrosswp' );
							break;

						case 'missing':
							$message = __( 'Invalid license.', 'acrosswp' );
							break;

						case 'invalid':
						case 'site_inactive':
							$message = __( 'Your license is not active for this URL.', 'acrosswp' );
							break;

						case 'item_name_mismatch':
							/* translators: the plugin name */
							$message = sprintf( __( 'This appears to be an invalid license key for %s.', 'acrosswp' ), $package['id'] );
							break;

						case 'no_activations_left':
							$message = __( 'Your license key has reached its activation limit.', 'acrosswp' );
							break;

						default:
							$message = __( 'An error occurred, please try again.', 'acrosswp' );
							break;
					}
				}
			}
